 ...
 * v0.1.5
 * ChangeLog:
 	* Setting all flags for pieces to false before finding
 	* whether pieces are present.
 */
package chess;
...
public class checking
{
	...
	{
		// set all pieces to false first
		flag_white_rook = false;
		flag_white_bishop = false;
		flag_white_queen = false;
		flag_white_knight = false;
		flag_white_pawn = false;
		flag_black_rook = false;
		flag_black_bishop = false;
		flag_black_queen = false;
		flag_black_knight = false;
		flag_black_pawn = false;
